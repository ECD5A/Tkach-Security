...
```console
npm install tkach-security-client@0.1.2
```
...
does not prove that an effect did not happen. The `0.1.2` package carries the
bounded deadline and slow-response hardening.
