...
Для терминальной панели запустите `tkach ui`. Выбирайте `1`, `2` или `3`,
нажимайте `F1`, вводите `/l`, либо используйте `/l en` и `/l ru`. Регистр и
алиасы языков (`en`, `eng`, `english`, `ru`, `rus`, `russian`) нормализуются.
