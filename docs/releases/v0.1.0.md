...
internet gateway, TLS termination, PyPI package, or Streamable HTTP service.
The v0.1.0 OCI image was built for Linux amd64/arm64,
pushed to GHCR, attested, and made public by the repository owner.
`tkach-mcp@0.1.0` is registered
...
OCI-образ v0.1.0 собран для Linux amd64/arm64, отправлен в GHCR, attested и
сделан публичным владельцем репозитория. `tkach-mcp@0.1.0` зарегистрирован в Official MCP Registry
