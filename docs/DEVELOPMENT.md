...
- current Productization cycle: added shared crate metadata, an honest
  unreleased changelog, and the local distribution/release contract; no crate,
  binary, container, or registry was published.
