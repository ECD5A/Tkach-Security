...
| Diode | Directional information-flow control | Separates read, export, and transfer decisions |
...
| Pechat | Secret-use isolation / broker boundary | Keeps raw secrets broker-side and denies reveal |
